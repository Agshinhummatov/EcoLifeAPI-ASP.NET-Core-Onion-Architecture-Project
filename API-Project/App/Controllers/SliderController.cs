...
namespace App.Controllers
{
    ...
    public class SliderController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType(statusCode: StatusCodes.Status200OK, Type = typeof(IEnumerable<SliderListDto>))]
        ...
        [HttpGet]
        [Route("{id}")]
        [ProducesResponseType(statusCode: StatusCodes.Status200OK, Type = typeof(SliderListDto))]
        [ProducesResponseType(statusCode: StatusCodes.Status404NotFound)]
        ...
        public async Task<IActionResult> Create([FromForm] SliderCreateDto slider)
        {
            try
            {
                await _service.CreateAsync(slider);
                return Ok();
            }
            catch (ArgumentNullException ex)
            {
        ...
        [ProducesResponseType(statusCode: StatusCodes.Status404NotFound)]
        [ProducesResponseType(statusCode: StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> Update([FromRoute] int id, [FromForm] SliderUpdateDto slider)
        {
            try
            {
